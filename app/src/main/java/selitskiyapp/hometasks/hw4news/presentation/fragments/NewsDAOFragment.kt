 ...
 * Use the [NewsDAOFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class NewsDAOFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NewsDAOFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NewsDAOFragment().apply {
